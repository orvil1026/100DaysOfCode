...
class CafeForm(FlaskForm):
    ...
    url = StringField("Location URL", validators=[DataRequired(), URL(message="Enter a Valid URL!")])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        print("True")
        new_cafe = [form.cafe.data, form.url.data, form.open_time.data, form.close_time.data, form.coffee_rating.data, form.wifi_rating.data, form.power_outlet.data]

        with open('cafe-data.csv',newline='', encoding='utf8', mode='a') as f_object:
